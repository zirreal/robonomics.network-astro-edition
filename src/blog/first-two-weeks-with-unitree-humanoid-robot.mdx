...
<RbGridWrapper columns="2" textAlign="center" align="end">
  <RbGridElement>
    <RbImage zoom src="./images/first-two-weeks-with-unitree-humanoid-robot/first-entering.webp" alt="Unitree humanoid robot first enter" />
  </RbGridElement>
  <RbGridElement>
    <RbImage zoom src="./images/first-two-weeks-with-unitree-humanoid-robot/cyclonedds-error.webp" alt="Unitree humanoid robot cyclonedds error" />
  </RbGridElement>
</RbGridWrapper>
